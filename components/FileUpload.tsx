...
export default function FileUpload({ onChange }: FileUploadProps) {
  ...
  return (
    <div className="flex flex-col items-center">
      <label className="w-full flex flex-col items-center px-4 py-6 bg-orange-500 md:bg-white text-white md:text-orange-500 rounded-lg tracking-wide uppercase border-2 border-orange-400 cursor-pointer hover:bg-orange-500 hover:text-white transition-all duration-700 ">
        <svg
          className="w-8 h-8"
          fill="currentColor"
